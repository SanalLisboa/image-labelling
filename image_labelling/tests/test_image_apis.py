...
from image_labelling.tests.utils import IMAGES, create_dummy_image_entries, USER_NAME, PASSWORD
...
class TestImageApi:
    ...
    def test_image_metadata_api(self, client):
        ...
        response = client.get(
            path, {'image_id': str(image_for_which_meta_data_is_fetched["image_id"])},
            HTTP_AUTHORIZATION="JWT {}".format(login_response.data["access"])
        )
